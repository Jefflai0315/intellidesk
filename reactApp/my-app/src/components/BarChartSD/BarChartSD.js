...
const formatTime = (minutes) => {
  ...
  return `${hours} hours ${mins} minutes`;
    ...
    <div className="group-33">
        <div className="overlap-group-4">
        <a  className={`text-wrapper-30 ${selectedTimeframeB === '24' ? 'active' : ''}`} onClick={() => setselectedTimeframeB('1d')}>24</a>
        <a  className={`text-wrapper-31 ${selectedTimeframeB === '25' ? 'active' : ''}`} onClick={() => setselectedTimeframeB('7d')}>25</a>
        <a  className={`text-wrapper-32 ${selectedTimeframeB === '26' ? 'active' : ''}`} onClick={() => setselectedTimeframeB('2w')}>26</a>
        <a  className={`text-wrapper-33 ${selectedTimeframeB === '27' ? 'active' : ''}`} onClick={() => setselectedTimeframeB('1m')}>27</a>
        <a  className={`text-wrapper-34 ${selectedTimeframeB === '28' ? 'active' : ''}`} onClick={() => setselectedTimeframeB('1m')}>28</a>
        <a  className={`text-wrapper-35 ${selectedTimeframeB === '29' ? 'active' : ''}`} onClick={() => setselectedTimeframeB('1m')}>29</a>
        <a  className={`text-wrapper-36 ${selectedTimeframeB === '30' ? 'active' : ''}`} onClick={() => setselectedTimeframeB('1m')}>30</a>
        </div>
      </div>
    </>  
  )   
